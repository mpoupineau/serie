...
class DashboardController extends Controller
{
	...
	public function indexAction()
    {
		...
		$collecteds = $this->get('collectedService')->findBy(array('user' => $user));
	...
	public function newEpisodesAction()
	{
		...
		return $this->render('AppBundle:Dashboard:listNewEpisode.html.twig',
	...
	public function seriesToSeeAction()
	{
		...
		return $this->render('AppBundle:Dashboard:seriesToSee.html.twig',
	...
	public function programAction()
	{
		...
		$user = $this->get('security.token_storage')->getToken()->getUser();
		return $this->render('AppBundle:Dashboard:program.html.twig',
			array('user'  => $user,
					'day' => $idDay));
	}
