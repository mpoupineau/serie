...
/*	public function getSeriesFilterAction(Request $request) 
	{
		...
		if ($request->isMethod('POST')) {
			...
			// return $this->render('DataBundle:Serie:seriesFilter.html.twig',
				// array('list_series'  => $list_series));
			$response = new JsonResponse();
			$response->setData(array(
				'nb_series' => count($list_series),
				'html' => $this->renderView('DataBundle:Serie:seriesFilter.html.twig',array('list_series'  => $list_series, 'page' => $num_page,'max_page' => $max_page))
			));
			return $response;
		}
	...
	*/
	...
	public function autocompleteAction()
	{
		...
		$script = $this->renderView('DataBundle:Serie:autocomplete.html.twig',
			array('series'  => $series));
	...
	public function formAction()
	{
		...
		return $this->render('AppBundle:Serie:form.html.twig', array(
