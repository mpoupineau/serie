 ...
 * @ORM\Entity(repositoryClass="DataBundle\Repository\EpisodeRepository")
 */
class Episode
{
    /**
	...
	/**
	* @ORM\ManyToOne(targetEntity="DataBundle\Entity\Serie", inversedBy="episodes")
	...
	*/
    ...
    public function populate($data) {
        ...
        if($data->firstAired != null) {
            $this->setFirstAired(\DateTime::createFromFormat('Y-m-d', $data->firstAired));
        }        
    }
}
