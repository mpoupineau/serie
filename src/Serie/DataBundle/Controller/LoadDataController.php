...
class LoadDataController extends Controller
{
	public function updateSeriesAction()
    {
		...
		$repositorySerie = $this->getDoctrine()->getManager()->getRepository('SerieDataBundle:Serie');
		...
		$repositoryEpisode = $this->getDoctrine()->getManager()->getRepository('SerieDataBundle:Serie');
    ...
    public function addSeriesAction(Request $request)
    {
		...
		if ($request->isMethod('POST')) {
			...
			if(isset($tab_serie))
				return $this->render('SerieDataBundle:LoadData:displayNewSerie.html.twig', array(
					'list_series'  => $tab_serie,
					'errors' => $errors,
					'slug' => $slug
					));
			else
				return $this->render('SerieDataBundle:LoadData:errorNewSerie.html.twig', array(
					'errors' => $errors,
					'slug' => $slug
					));
			
		}
		return $this->render('SerieDataBundle:LoadData:addSerie.html.twig', array(
